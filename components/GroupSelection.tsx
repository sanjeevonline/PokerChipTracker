...
import { Plus, Users, ChevronRight, Database, PlayCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="text-center py-8">
        ...
        <p className="text-neutral-400">Select a group to manage your games or create a new one.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <button 
           ...
           className="flex flex-col items-center justify-center h-40 rounded-xl border-2 border-dashed border-neutral-800 hover:border-red-600/50 hover:bg-neutral-900/50 transition-all group"
        >
           <div className="bg-neutral-900 p-3 rounded-full mb-3 group-hover:scale-110 transition-transform">
             <Plus className="text-red-500" size={24} />
           </div>
           <span className="font-bold text-neutral-300 group-hover:text-white">Create New Group</span>
        </button>
